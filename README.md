...
| [Закономерности, влияющие на успешность игры](https://github.com/ann-zrb/praktikum_projects/tree/93430fe7a3edec201bc22ea23f3f082cba57a283/games_market_analysis) | Для планирования рекламной кампании необходимо определить, что влияет на успешность компьютерной игры | *pandas*, *matplotlib*, *numpy*, *scipy* |
